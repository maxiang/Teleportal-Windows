    ...
    Item {
        ...
        Button
        {
            ...
            background: Rectangle {             
                    border.color: "black"
                    border.width: 3
                   // color: highspeed?selectcolor:nomalcolor
            }
           // onClicked: {highspeed=true;lowspeed=false;}
        }
        Button
        {
            id:bLow
            ...
            y:375
            background:Rectangle {
                  //  color: lowspeed?selectcolor:nomalcolor
                    border.color: "black"
                    border.width: 3}
             //onClicked: {highspeed=false;lowspeed=true;}
        }
        //one
        Image
        {
